...
void Application::Display(void)
{
	...
	case 3:
		m_pCamera->ResetCamera();
		m_pCamera->SetPositionTargetAndUpward(AXIS_X * 20, ZERO_V3, AXIS_Z * -1);
		break;
	case 4:
		m_pCamera->ResetCamera();
	...
	case 5:
		m_pCamera->ResetCamera();
		m_pCamera->SetPositionTargetAndUpward(AXIS_Z * -10.21f, ZERO_V3, AXIS_Y);
		break;
	case 6:
		m_pCamera->ResetCamera();
		m_pCamera->SetPositionTargetAndUpward(AXIS_Z * 0.0001f, ZERO_V3, AXIS_Y);
		m_pCamera->SetPerspective(false);
		break;
	case 7:
		m_pCamera->ResetCamera();
		m_pCamera->SetPositionTargetAndUpward(AXIS_Z * 10, ZERO_V3, AXIS_Y * -1);
		break;
	}
